    ...
    public class StatisticRepository : IStatisticRepository
    {
        ...
        public async Task<Statistic> GetStatistics()
        {
            Statistic statistics = new Statistic()
            {
                ...
                RecordCost = await _db.GetCostQueryAsync<decimal>("select sum(cost) from record where media = 'R'"),
                TotalRecords = await _db.GetCountOrIdQueryAsync("select sum(discs) from record where media = 'R'"),
                CDCost = await _db.GetCostQueryAsync<decimal>("select sum(cost) from record where media = 'CD'"),
                ...
                Cost2022 = await _db.GetCostQueryAsync<decimal>("select sum(cost) from record where bought > '31-Dec-2021' and bought < '01-Jan-2023'"),
                ...
                Cost2021 = await _db.GetCostQueryAsync<decimal>("select sum(cost) from record where bought > '31-Dec-2020' and bought < '01-Jan-2022'"),
                ...
                Cost2020 = await _db.GetCostQueryAsync<decimal>("select sum(cost) from record where bought > '31-Dec-2019' and bought < '01-Jan-2021'"),
                ...
                Cost2019 = await _db.GetCostQueryAsync<decimal>("select sum(cost) from record where bought > '31-Dec-2018' and bought < '01-Jan-2020'"),
                ...
                Cost2018 = await _db.GetCostQueryAsync<decimal>("select sum(cost) from record where  bought > '31-Dec-2017' and bought < '01-Jan-2019'"),
                ...
                Cost2017 = await _db.GetCostQueryAsync<decimal>("select sum(cost) from record where bought > '31-Dec-2016' and bought < '01-Jan-2018' "),
